            ...
            <div class="metadata">
                <div class="gallery ui-slider-disabled">
                    <div class="img-preview" style="background-image: none;">
                    	<img src="http://aimg.hai360.com/item/20141022/104058/405923.jpg" alt="#" style="height: 300px; width: 300px; margin: -150px 0px 0px -150px; display: inline;">
                    </div>
                </div>
            ...
            <script>
                $(function(){
                    $(document).on('click','#btn-addtocart',function(){
                        ...
                        $.ajax({
                            url:"{{url('home/shopCart/addShopCart')}}",
