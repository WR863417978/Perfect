...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">Cz后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li> {{ request()->cookie('admimuname') }} </li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<?php if(!empty($menu)) foreach($menu as $k=>$v){?>
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> {{ $v['auth_name'] }}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<?php if(!empty($v['child'])) foreach($v['child'] as $key=>$val){?>
				<ul>
					<li><a href=<?php
						echo url("admin/".$val['controller']."/".$val['functions']);
					?> title="批次申请">{{ $val['auth_name'] }}</a></li>
		</ul>
		<?php }?>
	</dd>
</dl>
